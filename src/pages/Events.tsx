...
const events = [
  {
    ...
    dateShort: 'MAY 1',
    title: 'Canvas Pickup Window',
    location: 'The Discovery',
    description: 'Registered artists can pick up their pre-cut canvas squares along with a reference image of their assigned section. Each canvas is ready to paint — bring your creativity and any painting materials you prefer. Pickup is available May 1 through June 1.',
    icon: <Star className="h-6 w-6" />,
    color: '#ffcc00',
    ongoing: true,
    ongoingText: 'May 1 – June 1',
  },
  {
    id: 'canvas-deadline',
    date: 'June 15, 2026',
